...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    title: "Forsoning",
    category: "Evangeliet",
    subcategory: "Forsoning",
    date: "2026-08-20",
    description:
      "Temaoversikt over forsoningens natur, Kristi soningsverk og de teologiske spørsmålene knyttet til Guds frelse og gjenopprettelse.",
    href: "/temaer/evangeliet/artikler/forsoning",
    design: "shared",
    migrated: true,
  },
  {
    slug: "problemer-med-psa",
    title: "Problemer med PSA",
    category: "Evangeliet",
    subcategory: "Forsoning",
    date: "2026-08-20",
    description:
      "En teologisk og bibelsk vurdering av hvorfor straffesubstitusjonsforsoning ikke holder, med fokus på tilgivelse, barmhjertighet, rettferdighet og soningsmodellen.",
    href: "/temaer/evangeliet/artikler/problemer-med-psa",
    design: "shared",
    migrated: true,
  },
  {
    slug: "forsoningens-natur",
    title: "Forsoningens natur",
    category: "Evangeliet",
    subcategory: "Forsoning",
    date: "2026-08-20",
    description:
      "En helhetlig, bibelsk fremstilling av Guds frelsesverk i Kristus, med fokus på fellesskap, pakt, seier, oppstandelse og kjærlighetens drivkraft i forsoningen.",
    href: "/temaer/evangeliet/artikler/forsoningens-natur",
    design: "shared",
    migrated: true,
  },
  {
    slug: "hva-er-en-mushaf",
    title: "Hva er en mushaf?",
    category: "Apologetikk",
    subcategory: "Islam",
    date: "2026-08-20",
    description:
  ...
  {
    slug: "muslimske-innvendinger",
    title: "De viktigste muslimske innvendingene",
    category: "Apologetikk",
    subcategory: "Islam",
    date: "2026-08-20",
    description:
      "En gjennomgang av de mest sentrale muslimske innvendingene mot Bibelen, med fokus på Koranens syn på tidligere skrifter og anklager om forfalskning.",
    href: "/temaer/apologetikk/artikler/muslimske-innvendinger",
    design: "shared",
    migrated: true,
  },
  {

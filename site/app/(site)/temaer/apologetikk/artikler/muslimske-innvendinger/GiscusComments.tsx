...
/**
 * Ko-lokalisert Giscus-klientkomponent, i samme mønster som andre artikler i
 * apologistikk-seksjonen. Dette er isolert per artikkel uten å introdusere en
 * ny global komponentsstruktur.
 */

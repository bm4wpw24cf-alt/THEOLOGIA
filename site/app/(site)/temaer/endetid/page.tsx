...
export const metadata: Metadata = {
  ...
  description: "Velg mellom de to hovedartiklene om død, helvete og evighet i Endetid.",
  alternates: {
...
const articles = [
  {
    ...
    description:
      "En teologisk utforskning av skjebnen til de ufrelste, med fokus på evig straff, helvete og Guds rettferdige dom.",
    href: "/temaer/endetid",
  },
  {
    title: "Er evig bevisst pine bibelsk? – Et svar til læren om utslettelse",
    description:
      "Et bibelsk og teologisk svar på om helvete er et sted for evig bevisst pine, eller om utslettelse er den riktige forståelsen.",
    href: "/temaer/endetid/artikler/er-evig-bevisst-pine-bibelsk",
  },
];

export default function EndetidOverviewPage() {
  return (
    <main>
      ...
      <section className="mx-auto w-[min(1280px,92%)] py-[90px]">
        <div className="mb-12 max-w-[780px]">
          <p className="mb-4 text-[0.8rem] font-semibold tracking-[0.14em] text-gold uppercase">Endetid</p>
          <h1 className="text-[2.8rem] font-semibold leading-[1.12] text-ink max-[640px]:text-[2.2rem]">
            To veier inn i forståelsen av død og evighet
          </h1>
          <p className="mt-5 max-w-[700px] text-[1.08rem] leading-[1.8] text-ink-soft">
            Her finner du to ulike, men sammenhengende artikler om død, helvete, dom og den endelige skjebnen til de
            ufrelste. Velg det emnet du vil dykke ned i.
          </p>
        </div>

...
export function Footer() {
  return (
    <footer className="bg-navy-deep pt-20 text-white/65">
      <div className="mx-auto grid w-[min(1280px,92%)] grid-cols-[1.6fr_1fr_1fr_1fr_1fr] gap-8 pb-14 max-[1100px]:grid-cols-2 max-[992px]:grid-cols-1 max-[992px]:text-center">
        <div>
          <Link href="/" className="flex items-center gap-3.5 max-[992px]:justify-center">
            <Image src="/images/logo.svg" alt="THEOLOGIA Logo" width={70} height={70} className="h-auto w-[70px] translate-y-[5px]" />
          </Link>
          <p className="mt-5 max-w-[240px] font-sans text-[0.88rem] text-white/45 max-[992px]:mx-auto">
        ...
        <div>
          ...
          <div className="flex gap-3 max-[992px]:justify-center">
